...
- Auto-download feature (v2.2.0) - now using correct import
- Configurable quote currency (v2.2.0)
- Fixed data download implementation (v2.2.1)
- Added missing _download_all_pair_data method (v2.2.2)
"""
import os
import json
import time
...
VERSION = "2.2.2"
CHANGELOG = {
    "2.2.2": "Added missing _download_all_pair_data method and fixed initialization order",
